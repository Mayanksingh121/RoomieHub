      ...
      <div className="flex relative w-[95%] bg-[#f84464] h-[100%] m-auto rounded-xl">
        <div className="w-[60%] text-white  mx-16 h-full pt-20 pl-16">
          ...
          <div className="flex gap-7 my-6">
            <button className="bg-white text-black px-20 py-2 rounded-lg font-body text-lg font-semibold hover:text-white hover:bg-black">Find room</button>
            <button className="bg-white text-black px-20 py-2 rounded-lg font-body text-lg font-semibold hover:text-white hover:bg-black">Find roomate</button>
          </div>
          <div>
            <img
